...
public class ConveyorLaneController
{
	...
	{
		ConveyorLane conveyerlane = conveyerlaneRepository.findById(conveyorLaneID).get();
		return conveyerlane;
	}
	...
	public ResponseEntity<HttpStatus> deleteConveyerlane(@PathVariable long conveyorLaneID)
	{
