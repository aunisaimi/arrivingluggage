...
/*	
	...
	public String updateTrackingSheet(@ModelAttribute TrackingSheet trackingsheet)
	{
		...
		if (trackingsheet.getTrackingsheetID()>0)
		{
			...
			restTemplate.put("http://localhost:8080/arriving/api/checkpoint1s", request, TrackingSheet.class);
		...
		else
		{
			...
			= restTemplate.postForObject("http://localhost:8080/arriving/api/checkpoint1s", request, String.class);
